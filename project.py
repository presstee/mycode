...
## to find
why = ['a job, ','coffee, ','clarity, ','bacon, ','friends, ','bitcoin, ',\
'a can of soda, ','a tutor, ','a mentor, ','breakfast, ','friends, ',\
...
## Then, he 
then = [' laughed ever so loud.',' started panicking.',' remained calm.',\
